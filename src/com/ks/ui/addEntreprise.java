...
public class addEntreprise extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 110, 230, 30));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 230, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, -1, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(this.jTextField2.getText().toString().trim().isEmpty()){
            this.jTextField2.setText("Entreprise-"+this.jTextField1.getText().toString().toUpperCase());
        }
        if(new dbOperations().addEntreprise(this.jTextField1.getText().toString().toUpperCase(), this.jTextField2.getText().toString())){
            String msg = "L'ajout de l'entreprise "+this.jTextField2.getText().toString()+" est un succes";
            JOptionPane.showMessageDialog(null, msg, "Succes", JOptionPane.INFORMATION_MESSAGE);
            this.setVisible(false);
        }
        else{
            String msg = "L'ajout de l'entreprise "+this.jTextField2.getText().toString()+" a rencontre des problemes";
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        if (this.jTextField1.getText().toString().matches("^[Ss]\\d{3}$") && this.jTextField1.getText().toString().trim().length() >= 4) {
            // input matches the pattern
            if(new dbOperations().checkNumEntreprise(this.jTextField1.getText().toString().toUpperCase())){
